        ...
        with dpg.window(label="Main docker window",
            ...
            with dpg.child_window(label="Main Window",
                ...
                dpg.add_menu_item(
                    ...
                    callback=lambda: dpg.show_item(items.file_selector.read))
                with dpg.menu(label="Export", parent=items.menu_bar.file):
                    with dpg.menu(label="PNG"):
                        dpg.add_menu_item(label="Image",
                                          callback=lambda: dpg.show_item(
                                              items.file_selector.export))
                        dpg.add_menu_item(
                            label="Selection",
                            tag=items.menu_bar.export_tab,
                            callback=lambda: dpg.show_item(items.file_selector.
                                                           export_image))
                    ...
                    with dpg.menu(label="RAW"):
                        ...
                        dpg.add_menu_item(
                            label="Selection",
                            callback=lambda: dpg.show_item(
                                items.file_selector.export_raw_selection))
