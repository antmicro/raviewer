...
from raviewer.parser.yuv import ParserYUV422P, ParserYUV420SP, \
    ParserYUV420P, ParserUYVY422PA
...
class TestYUVParserClass(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.parserY420 = ParserYUV420SP()
        ...
        self.parserY422 = ParserUYVY422PA()
